...
function AccountAdd() {
  ...
  const showAccountAddForm = () => (
    <div
      className="card border-text-info rounded-10"
        ...
        <div className="form-group">
          <div className="input-group mb-0">
            <input
              ...
              placeholder="Account Name (Enter account holder's institution/organisation name)"
              required
            />
        ...
        <div className="form-group">
          <div className="input-group mb-0">
            <input
              ...
              value={contactEmail}
              onChange={handleTextBoxChange}
              placeholder="Email Address (Account holder's login name)"
              required
            />
            <label className="text-danger ml-2">*</label>
          </div>
        ...
        <div className="form-group">
          <div className="input-group mb-0">
            <input
              ...
              value={loginPassword}
              onChange={handleTextBoxChange}
              placeholder="Password (Account holder's login password)"
              required
            />
            <label className="text-danger ml-2">*</label>
          </div>
  ...
  const showAccountAddFormClassSubjects = () => {
    return (
      <div
        className="card border-text-muted rounded-10"
        style={{ minHeight: "435px", maxHeight: "435px", overflow: "scroll" }}
      >
        <div className="card-header p-0">
          <div className="bg-text-muted text-dark text-center py-2 p-2">
            <h5>Class and Subjects for the Account</h5>
            <SelectClasses
              onClassChange={(v) => handleClassOnChange(v)}
                ...
                return (
                  <li key={cs.classSubjectID}>
                    <div className="row">
                      ...
                      <div className="col-5 text-left">{cs.classDesc}</div>
                      <div className="col-4 text-left">{cs.subjectDesc}</div>
                    </div>
                  </li>
                );
              })}
  ...
  const handleCheckBoxChange = (e) => {
    if (e.target.checked === true) {
      ...
      setCheckedItems(
        checkedItems.filter((id) => id !== Number(e.target.value))
      );
    }
  };
  ...
  const showErrorMessage = () =>
    account.error.length > 0 && (
      <div className="alert alert-danger  text-center">{account.error}</div>
    );
  ...
  const showSuccessMessage = () =>
    account.success.length > 0 && (
      <div className="alert alert-success text-center">{account.success}</div>
    );
  ...
  // ==========================================================
  return (
    <LayoutSuperAdmin title="Add new account">
