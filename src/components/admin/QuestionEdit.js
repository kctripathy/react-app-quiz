...
function QuestionEdit({ match }) {
      ...
      if (data !== undefined) {
        ...
        getAllClassSubjectsByAccountId(user.accountId).then((data1) => {
          if (data1 !== undefined && data1.status.code > 0) {
            ...
            const objClassSubject = getClassSubjectByID(
              data1.result,
              data.classSubjectId
            );
    ...
    return (
      <div>
        <form onSubmit={handleSubmit}>
          <div className="bg-text-muted text-dark text-left py-2 mb-4">
            <b>Select Class & Subject</b>:<br />
            {populateClasses()} &nbsp;&nbsp;
            {populateSubjects()}
          </div>
          ...
          <div className="form-group text-center">
            <button className="btn btn-primary btn-quiz">UPDATE</button>

            <Link
              className="btn btn-primary  btn-quiz ml-4"
              to="/questions/list"
            >
              LIST
            </Link>
  ...
  //================================================
  return (
    <LayoutTeacher title="Edit Question">
      <div className="row">
