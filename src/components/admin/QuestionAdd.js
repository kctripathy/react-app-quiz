...
function QuestionAdd() {
  ...
  const acessLevel = isAuthenticated().accessLevel;
  useEffect(() => {
    ...
    getAllClassSubjectsByAccountId(user.accountId).then((data) => {
    ...
    return (
      <div>
        <form onSubmit={handleSubmit}>
          <div className="bg-card-header text-dark text-left py-2 mb-4">
          ...
          <div className="form-group" style={{ display: "none" }}>
            <div className="input-group mb-2">
              <div className="input-group-append">
                <div className="input-group-text">Ques. Type:</div>
              </div>
              ...
              <div className="input-group-append">
                <div className="input-group-text">
                  <input
                    ...
                    checked={values.options[0].isAnswer}
                  />
                  &nbsp;is the answer
                </div>
              </div>
              ...
              <div className="input-group-append">
                <div className="input-group-text">
                  <input
                    ...
                    checked={values.options[1].isAnswer}
                  />
                  &nbsp;is the answer
                </div>
              </div>
              ...
              <div className="input-group-append">
                <div className="input-group-text">
                  <input
                    ...
                    checked={values.options[2].isAnswer}
                  />
                  &nbsp;is the answer
                </div>
              </div>
              ...
              <div className="input-group-append">
                <div className="input-group-text">
                  <input
                    ...
                    checked={values.options[3].isAnswer}
                  />
                  &nbsp;is the answer
                </div>
              </div>
          ...
          <div className="form-group text-center">
            ...
            <button
              ...
              onClick={() => resetValuesAfterSuccess("")}
            >
  ...
  const addQuestionsByTeacher = () => (
    <LayoutTeacher title="Add New Question">
      <div className="row">
      ...
      <div>{/* {JSON.stringify(values.options[0].optionName)} */}</div>
    </LayoutTeacher>
  );
  const addQuestionsByAdmin = () => (
    <LayoutAdmin title="Add New Question">
      <div className="row">
        <div className="col-12">
          {newQuestionForm()}
          {showErrorMessage()}
  ...
  const addQuestionsBySuperAdmin = () => (
    <LayoutSuperAdmin title="Add New Question">
      <div className="row">
        <div className="col-12">
          {newQuestionForm()}
          {showErrorMessage()}
  ...
  return acessLevel === Role.Teacher
    ? addQuestionsByTeacher()
    : acessLevel === Role.Admin
    ? addQuestionsByAdmin()
    : addQuestionsBySuperAdmin();
}
